...
This pillar carries the company's voice and personality that shapes how every asset reads.
...
[Instructions:
Provide the canonical About statement used across press releases, social profiles, partner listings, marketplaces, and any external surface that needs a fixed description of the company.]
...
[Instructions:
List 3-5 durable identity tenets that define what the company stands for. These are the recurring themes that color voice, design, and storytelling across every asset.]

[Tips:
- Brand pillars persist across product changes and market shifts
- Frame as identity statements, not promises
