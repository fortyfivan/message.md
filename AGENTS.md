...
2. **Assemble the context** by loading pillars, collections, and assets per the rules below, letting each scenario dimension shape the assembly:
   - **Compelling event** — load the profiles of any entities the event implicates (competitor, report, customer, etc.) and anchor timeliness.
   - **Market moment** — sets urgency and market framing.
   - **Strategic shape** — guides which pillars and collections to emphasize.
   - **Content lens** — sets altitude, level of product specificity, and CTA strength.
